...
void adpfloat_mul_template(
    const AdpfloatType<W, E> in_a,
    const AdpfloatType<W, E> in_b,
    NVINTW(F)& out) {
  ...
  // cout << "in_a.man " << in_a.man << " " << in_a.man.to_string(AC_BIN) <<
  // endl; cout << "in_a_tmp " << in_a_tmp << " " << in_a_tmp.to_string(AC_BIN)
  // << endl; cout << "in_b_tmp " << in_b_tmp << " " <<
  // in_b_tmp.to_string(AC_BIN) << endl; cout << "man_mul " << man_mul << " " <<
  // man_mul.to_string(AC_BIN) << endl; cout << "out " << out << " " <<
  // std::bitset<32>(out.to_int64()) << endl;
...
void adpfloat_add_template(
    const AdpfloatType<W, E> in_a,
    const AdpfloatType<W, E> in_b,
    AdpfloatType<W, E>& out) {
...
void adpfloat_mul(
    const AdpfloatType<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth> in_a,
    const AdpfloatType<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth> in_b,
    NVINTW(spec::kAccumWordWidth)& out) {
  adpfloat_mul_template<
      spec::kAdpfloatWordWidth,
...
void adpfloat_add(
  ...
  adpfloat_add_template<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth>(
      in_a, in_b, out);
}
...
void adpfloat_max(
    ...
    const AdpfloatType<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth> in_b,
    AdpfloatType<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth>& out) {
  adpfloat_max_template<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth>(
      in_a, in_b, out);
}
...
void adpfloat_mean(
    ...
    const AdpfloatType<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth> in_b,
    AdpfloatType<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth>& out) {
  adpfloat_mean_template<spec::kAdpfloatWordWidth, spec::kAdpfloatExpWidth>(
      in_a, in_b, out);
}
#endif
