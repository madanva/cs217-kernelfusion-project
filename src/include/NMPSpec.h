...
namespace spec {
  namespace NMP {
    // Floating point types for NMP computations
    typedef AdpfloatType<kAdpfloatWordWidth, kAdpfloatExpWidth> AdpType;
    typedef ac_float<6, 2, 5, AC_RND> ACFloatType;
    ...
    public:
      ...
      void ConfigWrite(
        ...
        if (write_index == 0x01) {
          ...
          adpbias_1      = nvhls::get_slc<kAdpfloatBiasWidth>(write_data, 96);
        }
      }
      ...
      void ConfigRead(
        ...
        if (read_index == 0x01) {
          ...
          read_data.set_slc<kAdpfloatBiasWidth>(96, adpbias_1);
        }
      }
    };
